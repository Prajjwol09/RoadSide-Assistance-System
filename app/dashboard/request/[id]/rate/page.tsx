// Rating page for users to rate helpers after service completion
    ...
    try {
      const response = await fetch("/api/ratings/create", {
        ...
        body: JSON.stringify({
          ...
          rated_id: request?.helper_user_id,
          stars: rating,
          ...
          <div className="max-w-2xl mx-auto">
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                <p className="text-muted-foreground mb-4">You have already rated this service</p>
    ...
    <div className="min-h-screen bg-muted/50">
      ...
      <main className="container py-6">
        <div className="max-w-2xl mx-auto">
          <Card>
            <CardHeader>
              <CardTitle>Rate Your Helper</CardTitle>
              <CardDescription>How was your experience with {request.helper_name}?</CardDescription>
            </CardHeader>
